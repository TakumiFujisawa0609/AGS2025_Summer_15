...
#include"../../../../Object/Player/Attack/Default.h"
#include"../../../../Object/Player/Attack/BPAttack.h"

class TutorialPlayer : public UnitBase
{
public:
...
private:
	...
	//状態ごとの関数を呼ぶための関数ポインタ
	void(TutorialPlayer::* stateFuncPtr)(void);
