...
private:
	...
	const std::wstring START_LINES_TABLE_CONTROLER[(int)TASK::MAX] =
	{
		L"",
	...
	const std::wstring START_LINES_TABLE_KEYBOARD[(int)TASK::MAX] =
	{
		L"",
		L"まずは基本の剣術からじゃ\nJキーで発動できる通常攻撃じゃ\n試しにその竹を切り倒してみろ",
		L"だがこの基本の剣撃はこんなものではないぞ\nあらゆるものを「相殺」「反射」することができるのだ\n試しにわしの攻撃を「相殺」しろみろ",
	...
	const std::wstring END_LINES_TABLE[(int)TASK::MAX] =
	{
		...
		L"そうだ、それで危険な攻撃からも逃れることができる\nしかし使うたびにクールタイムを要するのには注意しろ\nクールタイムは頭の上のゲージで確認できる\n頼りすぎないように気をつけろよ",
